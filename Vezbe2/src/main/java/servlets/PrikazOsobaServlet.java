...
//		String prezime = (String) servletContext.getAttribute("prezime");
		...
		for (int i = 0; i < osobe.size(); i++) {
			...
			response.getWriter().append("<a href=PrikazPojedinacneOsobe?" + i + ">Prikazi ovu osobu</a><br>");
			response.getWriter().append("<a href=BrisanjePojedinacneOsobe?" + i + ">Obrisi ovu osobu</a><br>");
			response.getWriter().append("<a href=IzmenaOsobe?" + i + ">Izmeni ovu osobu</a>");
		}

		response.getWriter().append("\r\n<br><br><a href=DodavanjeOsobe.html>Povratak</a>" + "</body>\r\n" + "</html>");
	}
